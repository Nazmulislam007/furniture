...
const vanities = [
   ...
   },
   {
      ...
      relatedImg: ['https://source.unsplash.com/_HqHX3LBN18', 'https://source.unsplash.com/FBXuXp57eM0'],
      createdAt: Math.round(faker.datatype.float({ max: 1000 })),
      color: faker.color.human(),
      vendor: faker.name.firstName(),
      location: faker.address.cityName(),
   ...
   },
   {
      ...
      name: 'Commoner',
      catagory: 'CounterX',
      relatedImg: ['https://source.unsplash.com/FBXuXp57eM0', 'https://source.unsplash.com/NvqYkDPE0Rw'],
      createdAt: Math.round(faker.datatype.float({ max: 1000 })),
      color: faker.color.human(),
      vendor: faker.name.firstName(),
      location: faker.address.cityName(),
   ...
   },
   {
      ...
      name: 'Venice',
      catagory: 'FloorDeco',
      relatedImg: ['https://source.unsplash.com/FV3GConVSss', 'https://source.unsplash.com/NvqYkDPE0Rw'],
      createdAt: Math.round(faker.datatype.float({ max: 1000 })),
      color: faker.color.human(),
      vendor: faker.name.firstName(),
      location: faker.address.cityName(),
   ...
   },
   {
      ...
      name: 'Alura',
      catagory: 'CounterX',
      relatedImg: ['https://source.unsplash.com/fZuleEfeA1Q', 'https://source.unsplash.com/FBXuXp57eM0'],
      createdAt: Math.round(faker.datatype.float({ max: 1000 })),
      color: faker.color.human(),
      vendor: faker.name.firstName(),
      location: faker.address.cityName(),
...
const productApi = { vanities, tiles, flooring, countertop, kitchenFaucets, bathroomFaucets, cabinets };
