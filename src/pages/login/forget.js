   ...
   return (
      ...
      >
         <FormControl>
            ...
            <Input name="email" type="email" onChange={handleChange} value={email.email} placeholder="johndoe@email.com" />
         </FormControl>
         <Stack direction="row" justifyContent="space-between" alignItems="center">
            <Button variant="contained" onClick={(e) => handleSubmit(e)} >Reset</Button>
         </Stack>
      </Box>
   );
}
