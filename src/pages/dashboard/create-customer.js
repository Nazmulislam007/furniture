...
export default function CreateCustomer() {
   ...
   const selectedStateCode = State.getStatesOfCountry('US').find((state) => state.name === customer?.state);
   ...
   return (
      <Box maxWidth="lg" marginX="auto" px={1} mb={8} mt={4}>
         <Box sx={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
            <Stack sx={{ flexBasis: { xs: '100%', lg: '60%' }, bgcolor: 'white', padding: { md: '40px 35px', xs: '30px 20px' } }}>
