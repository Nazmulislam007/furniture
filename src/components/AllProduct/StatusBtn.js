...
import {
	addToCartFn,
	removeToCart,
} from "@/Context/ProductInfoProvider/actions";
import { PLEASE_LOGIN, apiUrl } from "@/Context/constant";
...
export default function StatusBtn({ product, selected, setProductId }) {
	...
	const handleChange = async (e) => {
		...
		if (["tiles", "flooring", "counterTop"].includes(selected))
			return toast("This catagory can not be add here", "#e74c3c");
