...
export default function Settings() {
	...
	switch (serviceSettings) {
		case "Bathtub":
			content = (
				<BathtubCost setSettings={setSettings} setCategory={setCategory} />
			);
			break;
		...
		case "Tiles":
			content = (
				<TilesCost setSettings={setSettings} setCategory={setCategory} />
			);
			break;
		case "Kitchen Faucet":
			content = (
		...
		case "Shower Kit":
			content = (
				<ShowerKitCost setSettings={setSettings} setCategory={setCategory} />
			);
			break;
		case "Cabinets":
			content = (
				<CabinetCost setSettings={setSettings} setCategory={setCategory} />
			);
			break;
		case "Countertop":
			content = (
				<CountertopCost setSettings={setSettings} setCategory={setCategory} />
			);
			break;
		case "Flooring":
			content = (
				<FlooringCost setSettings={setSettings} setCategory={setCategory} />
			);
			break;
	}
