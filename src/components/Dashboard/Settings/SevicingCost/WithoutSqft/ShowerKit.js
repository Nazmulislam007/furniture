...
export default function ShowerKitCost({ setCategory, setSettings }) {
	...
	const data = {
		...
		removeBathtub: {
			[question.removeBathtub]:
				question.remove !== "Flat Rate" ? 0 : inputVal.removeBathtub,
		},
		removeShower: {
			[question.removeShower]:
				question.remove !== "Flat Rate" ? 0 : inputVal.removeShower,
		},
		dispose: {
			[question.dispose]:
