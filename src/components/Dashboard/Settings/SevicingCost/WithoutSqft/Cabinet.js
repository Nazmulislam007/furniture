...
export default function CabinetCost({setCategory,setSettings}) {
   ...
   const getServiceCostData = async (obj) => {
      ...
      if (result.length > 0) {
         ...
         const newData = { install, service, customerId, categoryId, deliver, paintDoors, paintBoxes, dispose, lighting }
   ...
   useEffect(() => {
      ...
      getServiceCostData({ selected: 'cabinets', customerId: userData?.customer_id })
   }, [])
   ...
   const data = {
      deliver: {
         [question.deliver]: question.deliver !== 'Flat Rate' || question.deliver !== 'Per Piece' ? inputVal.deliver :0 ,
      },
      install: {
         [question.install]: question.install !== 'Flat Rate' || question.deliver !== 'Per Piece' ? inputVal.install : 0,
      },
      remove: { [question.remove]: question.remove !== 'Flat Rate' || question.deliver !== 'Per Piece' ? inputVal.remove : 0 },
      dispose: {
         [question.dispose]: question.dispose !== 'Flat Rate' || question.deliver !== 'Per Piece' ? inputVal.dispose : 0,
      },
      lighting: {
         [question.lighting]: question.lighting !== 'Flat Rate' || question.deliver !== 'Per Piece' ? inputVal.lighting : 0,
      },
      paintDoors: {
         [question.paintDoors]: question.paintDoors !== 'Flat Rate' || question.deliver !== 'Per Piece' ? inputVal.paintDoors : 0,
      },
      paintBoxes: {
         [question.paintBoxes]: question.paintBoxes !== 'Flat Rate' || question.deliver !== 'Per Piece' ? inputVal.paintBoxes : 0,
      },
   };
      ...
      <Stack spacing={3} sx={{ bgcolor: 'white', padding: 4, flex: 1, width: '100%' }}>
         ...
         <List sx={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <Question quesitionName="install a new cabinet?">
               ...
               {(question.install === 'Flat Rate' || question.install === 'Per Piece') && (
                  <Input
                     disableUnderline
                     sx={{ border: '1px solid', padding: '4px', minWidth: 200 }}
            ...
            <Question quesitionName="remove an existing cabinet?">
               <Options options={options} value={question.remove} name="remove" onChange={handleQuestionChange} />
               {(question.remove === 'Flat Rate' || question.remove === 'Per Piece') && (
                  <Input
                     disableUnderline
                     sx={{ border: '1px solid', padding: '4px', minWidth: 200 }}
            ...
            <Question quesitionName="dispose an old cabinet?">
               ...
               {(question.dispose === 'Flat Rate' || question.dispose === 'Per Piece') && (
                  <Input
                     disableUnderline
                     sx={{ border: '1px solid', padding: '4px', minWidth: 200 }}
            ...
            <Question quesitionName="add lighting to cabinet?">
               <Options options={options} value={question.lighting} name="lighting" onChange={handleQuestionChange} />
               {(question.lighting === 'Flat Rate' || question.lighting === 'Per Piece') && (
                  <Input
                     disableUnderline
                     sx={{ border: '1px solid', padding: '4px', minWidth: 200 }}
            ...
            <Question quesitionName="paint new cabinet doors?">
               <Options options={options} value={question.paintDoors} name="paintDoors" onChange={handleQuestionChange} />
               {(question.paintDoors === 'Flat Rate' || question.paintDoors === 'Per Piece') && (
                  <Input
                     disableUnderline
                     sx={{ border: '1px solid', padding: '4px', minWidth: 200 }}
            ...
            <Question quesitionName="paint new cabinet boxes?">
               <Options options={options} value={question.paintBoxes} name="paintBoxes" onChange={handleQuestionChange} />
               {(question.paintBoxes === 'Flat Rate' || question.paintBoxes === 'Per Piece') && (
                  <Input
                     disableUnderline
                     sx={{ border: '1px solid', padding: '4px', minWidth: 200 }}
